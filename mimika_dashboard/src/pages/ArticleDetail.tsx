...
export default function ArticleDetail() {
  ...
  const [article, setArticle] = useState<{
    ...
    date: "2024-01-15",
    status: "pending",
    content: "Pemerintah mengumumkan kelanjutan pembangunan jalan Trans Papua yang menghubungkan Timika dengan wilayah lainnya di Papua. Proyek infrastruktur ini diharapkan dapat meningkatkan konektivitas dan aksesibilitas masyarakat Papua...",
  ...
  const relatedNews = [
    ...
    { id: "3", title: "Pembangunan Jembatan di Mimika Dimulai", source: "Timika Express", date: "2024-01-13" },
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Review and edit article</p>
          </div>
        </div>
