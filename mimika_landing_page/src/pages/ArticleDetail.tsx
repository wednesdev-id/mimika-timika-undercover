    ...
    const loadArticle = async () => {
      ...
      try {
        ...
        if (data) {
          setArticle({
            title: data.title,
            source: data.url || "Unknown Source", // Fallback as source name is not in NewsArticle
            date: data.date,
            status: "pending", // Default to pending as status is not in NewsArticle
            content: data.summary, // Mapping summary to content for now
            imageUrl: data.image,
