...
const mockArticles = [
    ...
    },
    {
        ...
        preview: "Festival budaya tahunan Timika akan digelar dengan menampilkan tarian tradisional dan pameran kerajinan lokal.",
    ...
    },
    {
        ...
        preview: "Dinas Kesehatan Timika meluncurkan program pemeriksaan kesehatan gratis untuk seluruh warga Timika sepanjang bulan Januari.",
        thumbnail: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=400",
        isNew: false,
    },
    {
        id: 5,
        title: "Peningkatan Infrastruktur Pendidikan di Timika",
        source: "Portal Berita Timika",
        date: "2024-01-13",
        status: "pending" as const,
        ...
        <AdminLayout>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-foreground">Katalog Berita Scraper (Timika)</h1>
